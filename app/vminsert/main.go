...
import (
	...
	vminsertCommon "github.com/aginetwork7/VictoriaMetrics/app/vminsert/common"
	"github.com/aginetwork7/VictoriaMetrics/app/vminsert/csvimport"
	"github.com/aginetwork7/VictoriaMetrics/app/vminsert/datadogsketches"
	"github.com/aginetwork7/VictoriaMetrics/app/vminsert/datadogv1"
	"github.com/aginetwork7/VictoriaMetrics/app/vminsert/datadogv2"
	"github.com/aginetwork7/VictoriaMetrics/app/vminsert/graphite"
	"github.com/aginetwork7/VictoriaMetrics/app/vminsert/influx"
	"github.com/aginetwork7/VictoriaMetrics/app/vminsert/native"
	"github.com/aginetwork7/VictoriaMetrics/app/vminsert/newrelic"
	"github.com/aginetwork7/VictoriaMetrics/app/vminsert/opentelemetry"
	"github.com/aginetwork7/VictoriaMetrics/app/vminsert/opentsdb"
	"github.com/aginetwork7/VictoriaMetrics/app/vminsert/opentsdbhttp"
	"github.com/aginetwork7/VictoriaMetrics/app/vminsert/prometheusimport"
	"github.com/aginetwork7/VictoriaMetrics/app/vminsert/prompush"
	"github.com/aginetwork7/VictoriaMetrics/app/vminsert/promremotewrite"
	"github.com/aginetwork7/VictoriaMetrics/app/vminsert/relabel"
	"github.com/aginetwork7/VictoriaMetrics/app/vminsert/vmimport"
	...
	"github.com/aginetwork7/VictoriaMetrics/lib/influxutils"
	graphiteserver "github.com/aginetwork7/VictoriaMetrics/lib/ingestserver/graphite"
	influxserver "github.com/aginetwork7/VictoriaMetrics/lib/ingestserver/influx"
	opentsdbserver "github.com/aginetwork7/VictoriaMetrics/lib/ingestserver/opentsdb"
	opentsdbhttpserver "github.com/aginetwork7/VictoriaMetrics/lib/ingestserver/opentsdbhttp"
	"github.com/aginetwork7/VictoriaMetrics/lib/procutil"
	"github.com/aginetwork7/VictoriaMetrics/lib/prompbmarshal"
	"github.com/aginetwork7/VictoriaMetrics/lib/promscrape"
...
func RequestHandler(w http.ResponseWriter, r *http.Request) bool {
	...
	if strings.HasPrefix(path, "/prometheus/api/v1/import/prometheus") || strings.HasPrefix(path, "/api/v1/import/prometheus") {
		...
		if strings.HasPrefix(path, "/prometheus/api/v1/import/prometheus/metrics/job/") ||
			...
			// See https://github.com/aginetwork7/VictoriaMetrics/issues/3636
	...
	if strings.HasPrefix(path, "/datadog/") {
		...
		// See https://github.com/aginetwork7/VictoriaMetrics/pull/2670
