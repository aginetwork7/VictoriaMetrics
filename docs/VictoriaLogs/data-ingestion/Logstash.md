...
- [Docker-compose demo for Logstash integration with VictoriaLogs](https://github.com/aginetwork7/VictoriaMetrics/tree/master/deployment/docker/victorialogs/logstash).
