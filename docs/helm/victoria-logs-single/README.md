...
<code class="language-yaml">[]
      ...
      <td><p>Additional environment variables (ex.: secret tokens, flags). Details are <a href="https://github.com/aginetwork7/VictoriaMetrics#environment-variables" target="_blank">here</a></p>
</td>
    </tr>
    <tr>
