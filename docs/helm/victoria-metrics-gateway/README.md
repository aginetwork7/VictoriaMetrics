...
<code class="language-yaml">[]
      ...
      <td><p>Additional environment variables (ex.: secret tokens, flags). Check <a href="https://github.com/aginetwork7/VictoriaMetrics#environment-variables" target="_blank">here</a> for details.</p>
</td>
    </tr>
    <tr>
      <td>envFrom</td>
